    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.CheckConstraint(condition=models.Q(('user', models.F('following')), _negated=True), name='user_cant_follow_himself', violation_error_message='Нельзя подписаться на самого себя!'), models.UniqueConstraint(fields=('user', 'following'), name='following_already_exists', violation_error_message='Этот пользователь уже добавлен.')],
            },
        ),
    ]
